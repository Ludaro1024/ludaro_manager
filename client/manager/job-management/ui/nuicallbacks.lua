...
RegisterNUICallback('addGrade', function(data, cb)
    ...
    print(data.jobName, data.gradeName, data.gradeLabel, data.salary)
    local success = addGrade(data.jobName, data.gradeName, data.gradeLabel, data.salary)
...
RegisterNUICallback('removeInteraction', function(data, cb)
    ...
    local success = deleteInteraction(data.jobName, data.index)
