MySQL.ready(function()
    ...
    local function createInteractionsTable()
        ...
        if #exists > 0 then
            -- print("^2[Ludaro-Manager] Table '^3ludaro_manager_interactions^2' already exists. No need to create it again.^0")
            return
        end
    ...
    local function createFarmingSpotsTable()
        ...
        if #exists == 0 then
            ...
            -- print("^2[Ludaro-Manager] Table '^3ludaro_manager_farmingspots^2' already exists. No need to create it again.^0")
        end
    end
